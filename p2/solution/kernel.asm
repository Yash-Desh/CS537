...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 62 59 10 80 	movl   $0x80105962,0x14(%eax)
  p->context = (struct context*)sp;
...
80105715:	8d 45 e8             	lea    -0x18(%ebp),%eax
{
...
8010574c:	0f 8e be 00 00 00    	jle    80105810 <sys_getparentname+0x100>
80105752:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80105755:	85 c9                	test   %ecx,%ecx
80105757:	0f 8e b3 00 00 00    	jle    80105810 <sys_getparentname+0x100>
  char *c;
...
8010575d:	e8 0e e2 ff ff       	call   80103970 <myproc>
80105762:	83 ec 0c             	sub    $0xc,%esp
80105765:	8b 40 14             	mov    0x14(%eax),%eax
80105768:	83 c0 6c             	add    $0x6c,%eax
8010576b:	50                   	push   %eax
8010576c:	e8 ef f0 ff ff       	call   80104860 <strlen>
80105771:	89 c6                	mov    %eax,%esi
  int size_c = strlen(myproc()->name);
80105773:	e8 f8 e1 ff ff       	call   80103970 <myproc>
80105778:	83 c0 6c             	add    $0x6c,%eax
8010577b:	89 04 24             	mov    %eax,(%esp)
8010577e:	e8 dd f0 ff ff       	call   80104860 <strlen>

  // check if childbuff & parentbuff are present & within allocated 
  // address space
  if(argptr(0, &p, pbuff) < 0 || argptr(1, &c, cbuff) < 0)
80105783:	83 c4 0c             	add    $0xc,%esp
80105786:	ff 75 e8             	push   -0x18(%ebp)
  int size_c = strlen(myproc()->name);
...
80105791:	e8 da f1 ff ff       	call   80104970 <argptr>
80105796:	83 c4 10             	add    $0x10,%esp
80105799:	85 c0                	test   %eax,%eax
8010579b:	78 73                	js     80105810 <sys_getparentname+0x100>
8010579d:	83 ec 04             	sub    $0x4,%esp
801057a0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057a3:	ff 75 ec             	push   -0x14(%ebp)
801057a6:	50                   	push   %eax
801057a7:	6a 01                	push   $0x1
801057a9:	e8 c2 f1 ff ff       	call   80104970 <argptr>
801057ae:	83 c4 10             	add    $0x10,%esp
801057b1:	85 c0                	test   %eax,%eax
801057b3:	78 5b                	js     80105810 <sys_getparentname+0x100>
  {
    return -1;
  }
...
801057b8:	85 d2                	test   %edx,%edx
801057ba:	74 54                	je     80105810 <sys_getparentname+0x100>
801057bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057bf:	85 c0                	test   %eax,%eax
801057c1:	74 4d                	je     80105810 <sys_getparentname+0x100>
  size_p++;
  size_c++;
  ...
  if(pbuff < size_p)
801057c3:	8b 45 e8             	mov    -0x18(%ebp),%eax
  size_p++;
801057c6:	83 c6 01             	add    $0x1,%esi
801057c9:	39 c6                	cmp    %eax,%esi
801057cb:	0f 4f f0             	cmovg  %eax,%esi
  {
    size_p = pbuff;
  }
...
801057ce:	8b 45 ec             	mov    -0x14(%ebp),%eax
  size_c++;
801057d1:	83 c3 01             	add    $0x1,%ebx
801057d4:	39 c3                	cmp    %eax,%ebx
801057d6:	0f 4f d8             	cmovg  %eax,%ebx
  {
    size_c = cbuff;
  }
...
801057f9:	83 c0 6c             	add    $0x6c,%eax
801057fc:	53                   	push   %ebx
801057fd:	50                   	push   %eax
801057fe:	ff 75 f4             	push   -0xc(%ebp)
80105801:	e8 1a f0 ff ff       	call   80104820 <safestrcpy>
  return 1;
80105806:	83 c4 10             	add    $0x10,%esp
80105809:	b8 01 00 00 00       	mov    $0x1,%eax
8010580e:	eb 05                	jmp    80105815 <sys_getparentname+0x105>
    return -1;
80105810:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80105815:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105818:	5b                   	pop    %ebx
80105819:	5e                   	pop    %esi
8010581a:	5d                   	pop    %ebp
8010581b:	c3                   	ret    
...
80105846:	e8 45 e2 ff ff       	call   80103a90 <growproc>
...
8010587d:	e8 9e f0 ff ff       	call   80104920 <argint>
...
80105895:	e8 06 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010589a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010589d:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
801058bd:	e8 7e e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
...
801058cf:	73 2f                	jae    80105900 <sys_sleep+0x90>
    if(myproc()->killed){
801058d1:	e8 9a e0 ff ff       	call   80103970 <myproc>
...
801058e5:	e8 56 ec ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105908:	e8 33 ec ff ff       	call   80104540 <release>
  return 0;
...
801059be:	00 00 ef 
  initlock(&tickslock, "time");
801059c1:	68 1d 7a 10 80       	push   $0x80107a1d
...
80105a44:	ff 24 85 c4 7a 10 80 	jmp    *-0x7fef853c(,%eax,4)
...
80105b25:	68 80 7a 10 80       	push   $0x80107a80
...
80105b77:	68 28 7a 10 80       	push   $0x80107a28
...
80105c93:	68 4c 7a 10 80       	push   $0x80107a4c
80105c98:	e8 03 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c9d:	83 c4 14             	add    $0x14,%esp
80105ca0:	68 22 7a 10 80       	push   $0x80107a22
...
80105d4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d4f:	bf 44 7b 10 80       	mov    $0x80107b44,%edi
...
80106a3d:	68 4c 7b 10 80       	push   $0x80107b4c
...
80106c6b:	68 91 7b 10 80       	push   $0x80107b91
...
80106cd0:	68 ab 7b 10 80       	push   $0x80107bab
...
80106d58:	68 4c 7c 10 80       	push   $0x80107c4c
...
80106df9:	68 c9 7b 10 80       	push   $0x80107bc9
...
80106e5b:	68 e1 7b 10 80       	push   $0x80107be1
...
80106f3c:	68 fd 7b 10 80       	push   $0x80107bfd
...
8010700c:	68 0e 7c 10 80       	push   $0x80107c0e
...
80107082:	68 18 7c 10 80       	push   $0x80107c18
...
80107157:	68 32 7c 10 80       	push   $0x80107c32
